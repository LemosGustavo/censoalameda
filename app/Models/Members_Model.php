...
class Members_Model extends MY_Model {
    ...
    public function __construct($db = null) {
        ...
        $this->id_name = 'id';
        $this->columnas = array('id', 'name', 'lastname','dni_document','address','email', 'phone', 'birthdate', 'gender_id', 'civil_state_id', 'path_photo', 'name_profession', 'artistic_skills', 'localities_id', 'boss_family', 'quantity_sons');
        $this->fields = array(
    ...
    protected $allowedFields    = ['name', 'lastname','dni_document','address','email', 'phone', 'birthdate', 'gender_id', 'civil_state_id', 'path_photo', 'name_profession', 'artistic_skills', 'localities_id', 'boss_family', 'quantity_sons'];
}
